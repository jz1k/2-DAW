...
function prepararPDF() {
    ...
    var listaCriteriosSeleccionados = document.getElementById('listaCriteriosSeleccionados'); // Cambiado el ID aquí

    // Verificar si los elementos existen antes de acceder a sus propiedades
    if (!pdfRA || !pdfCriterio || !listaCriteriosSeleccionados) {
    ...
    var allCriterios = obtenerCriteriosLista(listaCriteriosSeleccionados); // Cambiado el parámetro aquí
